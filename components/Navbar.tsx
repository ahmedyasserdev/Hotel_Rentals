      ...
      <nav className="relative z-30 flex-between container py-5">
        ...
        <ul
          className={`
            ...
            lg:relative lg:flex lg:h-full lg:gap-12 max-lg:w-[85%] max-lg:bg-secondary-1 transition-all duration-200  
            ${
              isOpen
                ? "max-lg:opacity-1 max-lg:translate-y-0"
                : "max-lg:opacity-0 max-lg:translate-y-[-1000%] z-[-100]"
            }
          `}
        >
          {NAV_LINKS.map((link) => (
            <Link
              ...
              className={`
                regular-20 hover:text-secondary-2 lg:regular-24 uppercase flex-center cursor-pointer pb-1.5 transition-all tracking-[1px] 
